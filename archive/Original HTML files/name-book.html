    ...
    <div class="book-hol-content-wrapper">
        <div class="jumbotron jumbotron-fluid rounded">
            <div class="container">
                ...
                <hr class="my-4">
                <p class="lead">
                    <a class="btn btn-success btn-lg" href="name-holiday.html" role="button">Check your holiday
                        allowance</a>
                </p>
            </div>
        </div>
                ...
                <div class="col">
                    ...
                    <div class="center-form" id="contact-form">
                        <form>
                            ...
                            <textarea name="projectsummary" id="projectsummary" rows="5" class="form-control"
                                placeholder="Hope you're doing something good!" required></textarea>
                            <input type="date" id="name-holiday" name="name-holiday">
                            <div class="form-row text-center">
                                <div class="col">
                                    <button type="submit" class="btn btn-secondary" onclick="submitForm()">Send Holiday
                                        Request</button>
                                </div>
                            </div>
                        </form>
